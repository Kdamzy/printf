 ...
 * @width: get width.
 * @precision: specifier of percision
 * @size: Size specifier
 *
...
/**
 * write_unsgnd - Writes the number of unsigned
 * @is_negative: Number indicating negative
 * @ind: Index at which the number starts in the buffer
 * @buffer: Array of character
 * @flags: Flags specifiers
 * @width: Width specifier
 * @precision: specifier of percsion
 * @size: Size specifier
 *
 ...
 *
 * Return: Number of written chaacters.
 */
